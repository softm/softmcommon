...
public class CalendarDialogBuilder {
    ...
    public CalendarDialogBuilder(Context ctx, OnDateSetListener listener, long initialDate,OnDateSetListener callBack) {
    	this.context = ctx;
    	this.dateSetlistener = listener;
    	this.initialDate = initialDate;
    	this.alertBuilder = returnDialog();
    ...
    public AlertDialog.Builder returnDialog() {
        ...
        AlertDialog.Builder aDBuilder = new AlertDialog.Builder(context)
                .setView(ll)
                .setPositiveButton(R.string.alert_confirm_str, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        dateSetlistener.onDateSet(YEAR, MONTH, DAY);
                    }
                })
                .setNegativeButton(R.string.alert_cancel_str, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
